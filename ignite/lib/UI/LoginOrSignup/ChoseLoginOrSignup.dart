...
import 'package:ignite/UI/BottomNavigationBar.dart';
import 'package:ignite/UI/HomeUIComponent/Home.dart';
import 'package:ignite/UI/LoginOrSignup/Login.dart';
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Center(
                                // Animation text ignite accept from splashscreen layout (Click to open code)
                                child: Hero(
                                  tag: "Ignite",
                                  child: Text(
                                    "Ignite",
                              ...
                              // Padding Text "Get best product in ignite" (Click to open code)
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: 160.0,
                                      right: 160.0,
